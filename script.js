...
function initModals() {
    ...
    function closeModal(modal) {
        ...
        // Check if we're closing a detailed modal (not part1-modal, part2-modal, part3-modal, part4-modal and not about-modal)
        const isDetailedModal = modal.id !== 'part1-modal' && 
                               modal.id !== 'part2-modal' &&
                               modal.id !== 'part3-modal' &&
                               modal.id !== 'part4-modal' &&
